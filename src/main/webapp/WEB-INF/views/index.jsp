...
<html lang="en">
<head>
<title>Gnanadurai Asudoss Profile</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Gnanadurai Asudoss | Resume" />
	...
	<div class="banner" id="home" >
			<div class="header">
				<div class="w3_agile_logo">
					<h1><a href="index.html">My Profile<span>WHO IAM</span></a></h1>
				</div>
				<div class="w3_menu">
			...
			<h2><span>HI! I'm</span> Gnanadurai Asudoss</h2>
				<div id="typed-strings" class="agileits_w3layouts_strings">
						<p>Java <i>DEVELOPER</i></p>
						<p>Big Data <i>DEVELOPER</i></p>
						<p>Web <i>DEVELOPER</i></p>
						<p>Android <i>DEVELOPER</i></p>
					</div>
			...
			<div class="w3_agileits_social_media">
				<ul>
					<li><a href="https://www.facebook.com/Gnani185" class="wthree_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
					<li><a href="https://twitter.com/gnani185" class="wthree_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
			...
			<div class="banner-image-w3layouts">
				<img src="images/men.png" alt=" " style="right: 0;zoom:1.2;" class="img-responsive" />
			</div>
	</div>
<!-- //banner -->
<!-- about -->
<div class="about" id="about">
	<div class="col-md-6 about-left-w3ls">
		...
		<h3 class="w3_head w3_head1">About Me <span>I am Gnanadurai Asudoss</span></h3>
		<p><span>Hi!, I am Gnanadurai Asudoss </span>It's my pleasure to introduce my self.. My strengths are my attitude that i like to take challenges that I CAN do it,my way of thinking that i take both success and failure in a balanced manner..</p>
			<ul>
				<li><span>Name</span>: Gnanadurai Asudoss</li>
				<li><span>Age</span>: 25 Years</li>
				<li><span>Experience</span>: 3+ Years</li>
				<li><span>Current Location</span>: Chennai</li>
				<li><span>Email</span>: <a href="mailto:gnani185@gmail.com">gnani185@gmail.com</a></li>
				<li><span>Phone</span>: +91 9787444349</li>
				<li><span>Website</span>: <a href="http://www.gnanadurai.com" target="_blank">www.gnanadurai.com</a></li>
				<li><span>Address</span>: 1/106 Middle Street, Pudhusurangudi, Sattur Virudhunagar - 626203</li>
				<li><a href="https://docs.google.com/document/d/1xGhfKaQr-4s58e1hBlaeXbCa9DFmastS/export?format=docx" class="botton-w3ls">Download CV</a>
				...
				<div class="modal-spa">
					<div class="skills"> 
						<div class="col-md-6 bar-grids bargrids-left">
							<h4><span class="glyphicon glyphicon-cog"></span> Java Skills </h4>
							<h6>Java  <span> 100% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 100%">
								</div>
							</div>
							<h6>J2EE  <span> 80% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 80%">
								</div>
							</div>
							<h6>Spring <span> 85% </span></h6>
							<div class="progress  w3-agile">
								<div class="progress-bar progress-bar-striped active" style="width: 85%">
								</div>
							</div>
							<h6>Spring MVC<span>90% </span></h6>
							<div class="progress  w3-agile">
								<div class="progress-bar progress-bar-striped active" style="width: 90%">
								</div>
							</div>
							<h6>Spring JDBC<span>85% </span></h6>
							<div class="progress  w3-agile">
								<div class="progress-bar progress-bar-striped active" style="width: 85%">
								</div>
							</div>
							<h6>Web Services <span> 75% </span></h6>
						...
						<div class="col-md-6 bar-grids  w3-agile">
							<h4><span class="glyphicon glyphicon-briefcase"></span> Hadoop Skills </h4>
							<h6>MapReduce<span> 85% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 85%">
								</div>
							</div>
							<h6>Apache Oozie<span> 95% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 95%">
								</div>
							</div>
							<h6>Apache Kafka<span>90% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 90%">
								</div>
							</div>
							<h6>Apache Storm<span>75% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 75%">
								</div>
							</div>
							<h6>Apache HBase<span>85% </span></h6>
							<div class="progress">
								<div class="progress-bar progress-bar-striped active" style="width: 85%">
								</div>
							</div>
							<h6>Apache Solr<span>75% </span></h6>
	...
	<div class="container">
		...
		<div class="work-info-agileits">
			<div class="col-md-4 work-left-agileits-w3layouts">
				<h6><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Sep-2014 to Present</h6>
			</div>
			<div class="col-md-8 work-right-w3-agileits">
				<h3>HTC Global Services /<span> Java & Hadoop Developer</span></h3>
		...
		<div class="work-info-agileits">
			<div class="col-md-4 work-left-agileits-w3layouts">
				<h6><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 2010-2014</h6>
			</div>
			<div class="col-md-8 work-right-w3-agileits">
				<h3>Jayaram College of Engg & Tech / <span> B.Tech-IT</span></h3>
				<p>Percentage : 77%</p>
			</div>
			<div class="clearfix"> </div>	
		</div>
		<div class="work-info-agileits">
			<div class="col-md-4 work-left-agileits-w3layouts">
				<h6><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 2009-2010</h6>
			</div>
			<div class="col-md-8 work-right-w3-agileits">
				<h3>S.H.N Edward Higher Secondary School / <span> HSC</span></h3>
				<p>Percentage : 76%</p>
			</div>
			<div class="clearfix"> </div>	
		</div>
		<div class="work-info-agileits">
			<div class="col-md-4 work-left-agileits-w3layouts">
				<h6><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 2007-2008</h6>
			</div>
			<div class="col-md-8 work-right-w3-agileits">
				<h3>S.H.N Edward Higher Secondary School / <span> SSLC</span></h3>
				<p>Percentage : 88%</p>
			</div>
			<div class="clearfix"> </div>	
		</div>
			 ...
			 <div class="sub_grid gallery_w3l">
				   <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-c grid_w3l">
						<a class="cm-overlay" href="images/gg2.jpg">
							<img src="images/gg2.jpg" alt=" " class="img-responsive" />
				   ...
				   <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-b grid_w3l">
					 	<a class="cm-overlay" href="images/gg3.jpg">
							<img src="images/gg3.jpg" alt=" " class="img-responsive" />
		   ...
		   <div class="sub_grid">
			   <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-c grid_w3l">
          			<a class="cm-overlay" href="images/gg4.jpg">
						<img src="images/gg4.jpg" alt=" " class="img-responsive" />
						<div class="w3agile-text w3agile-text-small full-height-w3">
							<h5>Project 4</h5>
						</div>
					</a>
			   ...
			   <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-d grid_w3l">
					<a class="cm-overlay" href="images/gg5.jpg">
						<img src="images/gg5.jpg" alt=" " class="img-responsive" />
						<div class="w3agile-text w3agile-text-smal1 full-height-w3">
							<h5>Project 5</h5>
						</div>
					</a>
		    ...
		    <div class="grid-1 grid-2">
				<a class="cm-overlay" href="images/gg6.jpg">
					<img src="images/gg6.jpg" alt=" " class="img-responsive" />
					<div class="w3agile-text w3agile-text-smal1">
							<h5>Project 6</h5>
					</div>
				</a>
...
<div class="contact" id="contact">
	<h3 class="w3_head w3_head1">Contact Me <span>Get in touch with me</span></h3>
		...
		<div id="map"></div>
			<!-- Map-JavaScript -->
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyARQhjrXyQMPdCJwp6CwRjuvhiEgBc8fiA"></script>        
			<script type="text/javascript">
				google.maps.event.addDomListener(window, 'load', init);
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(12.994155, 80.206298),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(12.994155, 80.206298),
						map: map,
					});
				}
			</script>
...
<div class="contact-info">
 <div class="container">
	...
	<div class="col-md-4 contact-grids contact-mid">
		<h5>Contact Info</h5>
		<ul>
			<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9787444349</li>
			<li><i class="fa fa-map-marker" aria-hidden="true"></i>1/106 Middle Street, Pudhusurangudi, Sattur, Virudhunagar - 626203</li>
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:gnani185@gmail.com">gnani185@gmail.com</a></li>
		</ul>
	</div>
	<!--<div class="col-md-4 contact-grids">
		<h5>My Twitter</h5>
		<div  class="callbacks_container">
				<ul class="rslides" id="slider3">
					<li>
						<i class="fa fa-twitter" aria-hidden="true"></i>Praesent imperdiet diam sagittis, egestas <a href="#" class="mail">
						@http://t.co/9vslJFpW</a> <span>ABOUT 15 MINS</span>
					</li>
					<li>
						<i class="fa fa-twitter" aria-hidden="true"></i>Diam sagittis, egestas praesent imperdiet<a href="#" class="mail">
						@http://t.co/9vslJFpW</a> <span>ABOUT 2 HOURS</span>
					</li>
					<li>
						<i class="fa fa-twitter" aria-hidden="true"></i>Imperdiet diam sagittis, praesent egestas <a href="#" class="mail">
						@http://t.co/9vslJFpW</a> <span>ABOUT 3 DAYS</span>
					</li>
					<li>
						<i class="fa fa-twitter" aria-hidden="true"></i>Egestas praesent imperdiet diam sagittis <a href="#" class="mail">
...
<div class="copy-w3-agile">
	<p>Copyright 2018 Gnanadurai Asudoss. All Rights Reserved.</p>	
</div>
<!--//footer-->	
